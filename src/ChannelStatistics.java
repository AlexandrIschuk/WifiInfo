...
public class ChannelStatistics {
    ...
    private void calculateStatistics() {
        ...
        avgNetworks = totalChannels > 0 ? totalNetworks / totalChannels : 0;
    ...
    public String getAvgNetworksFormatted() {
        return String.format("%.1f", avgNetworks);
    }
    ...
    public String getRecommendations() {
        ...
        int totalNetworks = channelStats.values().stream()
                .mapToInt(ChannelInfo::getNetworkCount)
                .sum();

//        rec.append(String.format("Общая статистика:\n"));
//        rec.append(String.format("   • Активных каналов: %d\n", totalChannels));
//        rec.append(String.format("   • Всего сетей: %d\n", totalNetworks));
//        rec.append(String.format("   • 2.4 GHz каналов: %d\n", channels24));
//        rec.append(String.format("   • 5 GHz каналов: %d\n", channels5));
//        rec.append(String.format("   • Средняя загрузка: %.1f%%\n\n", avgLoad));
    ...
    private String getTopRecommendations() {
        ...
        // Топ-3 наименее загруженных канала
