...
public class WifiScanner {
    ...
    public static class WLAN_CONNECTION_PARAMETERS extends Structure {
        public int wlanConnectionMode;
        public Pointer strProfile;
        public Pointer pDot11Ssid;
        public Pointer pDesiredBssidList;
        public int dot11BssType;
        public int dwFlags;

        public WLAN_CONNECTION_PARAMETERS() {
        }
    ...
    public static final int WLAN_CONNECTION_MODE_PROFILE = 0;
    public static final int WLAN_CONNECTION_MODE_TEMPORARY_PROFILE = 1;
